...
public abstract class AbstractJavaToolChain implements JavaToolChainInternal {
    protected final JavaCompilerFactory compilerFactory;
    protected final ExecActionFactory execActionFactory;

    public AbstractJavaToolChain(JavaCompilerFactory compilerFactory, ExecActionFactory execActionFactory) {
    ...
    protected class JavaToolProvider implements ToolProvider {
        @Override
